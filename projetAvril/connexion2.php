...
<div class="container">
        ...
        <form method="POST" action="monProjet.php">
            <p class="h4 text-center py-4"><u>Se connecter !!!</u></p>
            ...
            <div class="text-center py-4 mt-3">
                <button class="btn peach-gradient btn-lg" type="submit">Connexion</button>
                <p><strong><a href="inscription2.php"><u>S'inscrire !!!</u></a></strong><p>
            </div>
