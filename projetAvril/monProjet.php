<?php 
 ...
 if(isset($_POST) AND $_SERVER['REQUEST_METHOD']=="POST"){  
        ...
        $db = Database::connect();
        $item = $db->prepare('INSERT INTO entreprise (nom,prenoms,email,telephone,plan,nbrPieces,espace,typePro ) VALUES(?,?,?,?,?,?,?,?)');
        $item->execute(array($nom,$prenoms,$email,$telephone,$plan,$nbrPieces,$espace,$typePro));
...
body{
      ...
      background-size:cover;
            ...
            #fondMais{
            background:url("image/entrep1.jpg")no-repeat;   
            background-size:cover;
            height: 500px;
            }
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top scrolling-navbar">
    ...
    <form enctype="multipart/form-data" method="POST" action="">
           <br><br><center><h3><u>INFORMATIONS DU CLIENT</u></h3></center>
           ...
           <input type="text" id="type" name="typePro" class="form-control" required="" />

           <label for="img">Plan</label>
           <input type="file" id="img" name="plan" class="form-control" required="" />

           <label for="nbr">Nombre de pièces</label>
           <input type="number" id="nbr" name="nbrPieces" class="form-control" required="" />
           ...
           <input type="submit" id="valider" name="submit"  value="Envoyer"  class="btn btn-success"/>
       </form> 
